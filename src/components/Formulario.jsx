...
return (
    ...
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        <h2 className="text-orange-900  font-black text-3xl text-center"> Seguimiento Pacientes</h2>

        <p className=" text-orange-900 text-xl mt-5 text-center mb-10">
          Añade Pacientes y  {''}
          <span className="text-orange-600 font-bold">Adminístralos</span>
        </p>
